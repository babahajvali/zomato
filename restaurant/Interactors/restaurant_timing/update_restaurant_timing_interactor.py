from restaurant.Interactors.Mixins.restaurant_timing_mixin import TimingMixin
...
class UpdateRestaurantTimingInteractor(TimingMixin):
    ...
    def update_restaurant_timing(
        ...
        self.check_restaurant_timing_valid(id=update_restaurant_timing_dto.id)

        self.check_restaurant_owner_valid(
